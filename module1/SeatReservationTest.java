...
public class SeatReservationTest  {
  ...
  public void canGetAndSetAllState() {
    ...
    assertEquals( "Fred", sr.getFirstName());
    assertEquals("Flintstone", sr.getLastName());
    assertEquals(date, sr.getFlightDate());
    assertEquals("DL1331", sr.getFlightDesignator());
  }
  ...
  public void toStringProducesCorrectStringWithAllNulls() {
    SeatReservation sr = new SeatReservation();
    assertEquals("SeatReservation{flightDesignator=null"+
                 ",flightDate=null"+
                 ",firstName=null"+
                 ",lastName=null}",
                 sr.toString());
  ...
  public void toStringProducesCorrectStringWithMixOfNulls() {
    ...
    sr.setFlightDate(date);
    sr.setFlightDesignator("DL1331");
    assertEquals("SeatReservation{flightDesignator=DL1331"+
